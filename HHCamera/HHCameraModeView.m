...
- (void)setCameraMode:(THCameraMode)cameraMode {
    if (_cameraMode != cameraMode) {
        ...
        if (cameraMode == THCameraModePhoto) {
            ...
            self.captureButton.captureButtonMode = HHCaptureButtonModePhoto;
            self.layer.backgroundColor = [UIColor blackColor].CGColor;
        } else {
            self.captureButton.captureButtonMode = HHCaptureButtonModeVideo;
